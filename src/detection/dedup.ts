...
export async function semanticDedup(fetcher: FetchLike, model: ModelConfig, ruleFindings: Finding[], modelFindings: Finding[]): Promise<Finding[]> {
  ...
  try {
    ...
    }, prompts.shapeDedup, DedupDecisionSchema);
